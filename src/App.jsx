...
<p className="text-slate-500 text-sm md:text-base mb-6">
    Open Source Contributor • GSSoC'26 • Competitive Programmer
</p>
...
<section id="skills" className="max-w-5xl mx-auto px-6 py-20 border-t border-slate-900">
    ...
    "skills": ["Streamlit", "REST APIs","FAST APIs", "Docker", "Node.js (Backend)", "React.js (Frontend)"]
    },
    {
    ...
    "skills": ["Git","GitHub","VS Code","Power BI","Postman"]
    }
].map((category, idx) => (
